...
![gaussian-elimination](/assets/gaussian-elimination.jpeg)
...
![long-division](/assets/long-division.jpeg)
...
As we saw above, an essential feature of the single variable case that makes the Euclidean algorithm work is the ability to do long division. Put it another way, given polynomial $p$ and polynomial divisor $f$ , we can find the quotient polynomial $q$ such that $p = qf + r$ with $r$ having lower degree than the divisor $f$. We seek to generalise the above in two ways: 
